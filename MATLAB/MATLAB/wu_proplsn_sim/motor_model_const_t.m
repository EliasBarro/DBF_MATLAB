...
T_des_kgf_list = 5; %Desired thrust

% Aero Params
V = 21; %Estimated velocity (m/s). V = 0 requires static thrust data
...
path = 'UIUCpropDB/';
file = '15x10at8700rpmQProp.txt'; %'rusp_11x4_static_2952os.txt';
