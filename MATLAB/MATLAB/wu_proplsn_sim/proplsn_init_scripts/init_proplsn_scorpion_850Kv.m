function init_proplsn_scorpion_850Kv
% init function for the standalone propulsion model - populate parameters for
% Motor: https://www.scorpionsystem.com/catalog/helicopter/motors_4/hkiv-40/HKIV_4025_850/
% Max. continuous power:	2812W
% Max. continuous current:	95A
% Mass:						347g

%nimh battery tlu
num_series                = 10; %0.0672 kg/cell
num_parallel			  = 2;
...
path = 'UIUCpropDB/';
file = 'apce_14x12_kt1069_3507.txt'; %Propeller: https://www.apcprop.com/product/14x12/
...
proplsn.R_sys_ohm = 0.009 + proplsn.internal_resistance + (0.0047*0.5); %Ohm (resistance of the motor plus resistance of the battery plus wiring resistance)
proplsn.K_v = 850;      % Kv, rpm/volt
proplsn.K_T_Nm_A = 0.095; % Kt, Nm/A <---this was a guess that was iterated on until the efficiency look reasonable
I_0 = 3.69;              % No-load current A   % ^Basically, make sure that mechanical power is somewhere around 0.9 times electrical power
