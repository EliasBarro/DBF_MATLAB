...
% bring in prop data
path = 'UIUCpropDB/';
file = 'apce_9x9_2501rd_5913.txt';%'apce_11x10_pg0462_5501.txt';%'apce_9x9_2501rd_5913.txt';%'apce_9x6_rd0994_6715.txt';%'apce_9x7.5_2551rd_6014.txt';%'apce_8x8_2812rd_6420.txt'; %'apce_8x6_2804rd_6712.txt';
...
proplsn.K_v = 350; %323.9     % rpm/volt
...
proplsn.bp_u_fs = linspace(0,60,30);
