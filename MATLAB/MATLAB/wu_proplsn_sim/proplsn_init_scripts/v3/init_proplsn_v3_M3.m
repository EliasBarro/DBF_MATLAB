function init_proplsn_v3_M3
% Modification of v2 M3: With a reasonable estimate for battery
% capacity and mass
...
% bring in prop data
path = 'UIUCpropDB/';
file = 'apce_8x8_2812rd_6420.txt'; %'apce_8x6_2804rd_6712.txt';
