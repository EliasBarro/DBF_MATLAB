...
% 180 degree right turn
mission_plan(10,:) = {mp.turn_radi, -turnBackRadius, {'0',1}, {'psi_dot',-pi}, 'false', 'false'};

% go straight until 500 from start
mission_plan(11,:) = {mp.cruise_thr, cruise_thr, {'0',1}, {'0',1}, 'east>500/3.281', 'false'}; % End of first loop
...
% 180 degree right turn
mission_plan(16,:) = {mp.turn_radi, -turnBackRadius, {'0',1}, {'psi_dot',-pi}, 'false', 'false'};

% go straight until 500 from start
mission_plan(17,:) = {mp.cruise_thr, cruise_thr, {'0',1}, {'0',1}, 'east>500/3.281', 'false'}; % End of second loop
...
% 180 degree right turn
mission_plan(22,:) = {mp.turn_radi, -turnBackRadius, {'0',1}, {'psi_dot',-pi}, 'false', 'false'};  % End of final loop

% go straight until even with start
mission_plan(23,:) = {mp.cruise_thr, cruise_thr, {'0',1}, {'0',1}, 'east<0', 'false'}; 
%% LANDING
% glide at -10 degrees until clearance altitude is less than 1.5m
mission_plan(24,:) = {mp.glide, -11, {'0',1}, {'0',1}, ['h<', num2str(init_alt+2)], 'false'};
...
% roll out
mission_plan(28,:) = {mp.ground_thr,  0, {'0',1}, {'0',1}, 'v<5', 'false'};
