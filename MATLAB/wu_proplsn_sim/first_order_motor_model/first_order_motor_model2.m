...
T_des_kgf_list = 4:1:8; %Desired thrust
...
I_0 = 2.1; %Motor no-load current (A)
...
mult_num_pts = 20; %Multiply the number of datapoints by this constant w/ spline interpolation
...
%Plot x-limits:
RPMLim = [min(RPM),15000]; %[min(RPM),max(RPM)];
