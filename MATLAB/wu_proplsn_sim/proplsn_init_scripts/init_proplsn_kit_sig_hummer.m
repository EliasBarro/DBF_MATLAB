function init_proplsn_kit_sig_hummer
...
proplsn.V_nom_batt = num_series*4.2; % LiPo nominal voltage = 3.7V
cell_max_cap_Ah = 1.5;
...
% bring in prop data
path = 'UIUCpropDB/';
file = 'da4002_5x4.92_1195ga_6041.txt';%'gwsdd_4x4_0443rd_10068.txt';
prop_table = importdata([path,file]);
prop_table = prop_table.data;
proplsn.prop_dia_in = 6;
...
proplsn.R_sys_ohm = 0.1 + proplsn.internal_resistance + (0.0132*0.1); %Ohm (resistance of the motor plus resistance of the battery plus wiring resistance)
proplsn.K_v = 1300; %323.9      % rpm/volt
