function init_proplsn_v4_Flight1b
...
% bring in prop data
path = 'UIUCpropDB/';
file = 'apce_14x12_kt1070_3504.txt'; %'apce_11x8_pg0524_6000.txt'; %'apce_9x6_rd0994_6715.txt';%'apce_9x7.5_2551rd_6014.txt';%'apce_8x8_2812rd_6420.txt'; %'apce_8x6_2804rd_6712.txt';
prop_table = importdata([path,file]);
prop_table = prop_table.data;
proplsn.prop_dia_in = 15;
